...
class _AuthApi implements AuthApi {
  ...
  Future<HttpResponse<BaseResponse<RefreshTokenModel>>> refreshToken(
    ...
    _data.addAll(body);
    final _options =
        _setStreamType<HttpResponse<BaseResponse<RefreshTokenModel>>>(
          Options(method: 'POST', headers: _headers, extra: _extra)
              .compose(
                _dio.options,
                'api/auth/refresh',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<RefreshTokenModel> _value;
    try {
      _value = BaseResponse<RefreshTokenModel>.fromJson(
        _result.data!,
        (json) => RefreshTokenModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
